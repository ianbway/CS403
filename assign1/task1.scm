...
(define (cyan value)
	(int (+ (* 255 (cos (* (/ 3.14159265358979323846 200) value))) 0.00000001))
	)


(define (yellow value)
	(int (+ (+ 255 (* 255 (sin (* (/ (* -2 3.14159265358979323846) 200) value)))) 0.00000001))
	)


(define (magenta value)
	(int (+ (+ (/ 255 2) (* (/ 255 2) (cos (* (/ (* -3 3.14159265358979323846) 200) value)))) 0.00000001))
	)
